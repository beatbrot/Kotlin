...
abstract class FirCachesFactory : FirSessionComponent {
    ...
    abstract fun <K : Any, V, CONTEXT> createCacheWithSuggestedLimits(
        ...
        keyStrength: FirCacheKeyReferenceStrength = FirCacheKeyReferenceStrength.STRONG,
        valueStrength: FirCacheValueReferenceStrength = FirCacheValueReferenceStrength.STRONG,
        createValue: (K, CONTEXT) -> V,
    ): FirCache<K, V, CONTEXT>
...
enum class FirCacheKeyReferenceStrength {
    /**
...
enum class FirCacheValueReferenceStrength {
    /**
     * An ordinary strong reference.
     */
    STRONG,
...
inline fun <K : Any, V> FirCachesFactory.createCacheWithSuggestedLimits(
    expirationAfterAccess: Duration? = null,
    maximumSize: Long? = null,
    keyHardness: FirCacheKeyReferenceStrength = FirCacheKeyReferenceStrength.STRONG,
    valueHardness: FirCacheValueReferenceStrength = FirCacheValueReferenceStrength.STRONG,
    crossinline createValue: (K) -> V,
